...
It also requires METIS. For the installation of METIS please see [https://github.com/KarypisLab/METIS](https://github.com/KarypisLab/METIS).
Note that we only tested the implementation with the configuration:
i64=0             - Sets to 32 bits the width of the datatype that will store information
                    about the vertices and their adjacency lists. 
r64=0             - Sets to 32 bits the width of the datatype that will store information 
                    about floating point numbers.

Next clone this repository:
```
git clone https://github.com/mkochh/HmatRBFFDOseen
```
