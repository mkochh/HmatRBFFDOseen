    ...
    ClusteringOptions cluster_opt, AdmissibilityOptions adm_opt, real heps, HArith harith, TruncType trunc_type, int cg_support_size)
{
    ...
    Csp_Data csp_data = getCSP(mat_h2, oseen_mat, rootv, rootp, adm_opt);
...
int main(int argc, char **argv) {
    ...
    file_base << "Daten/csp_" << domain_name[static_cast<int>(rbffd_opt.domain_geometry)] 
    << "_" << partition_name[static_cast<int>(cluster_opt.partition_type)] << "_" << separator_name[static_cast<int>(cluster_opt.separator_type)] 
